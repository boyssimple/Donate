...
#import "iCellScrollView.h"

@interface iCellScrollView()<UIScrollViewDelegate>
...
@end
@implementation iCellScrollView
...
-(void)setPageControlPosition:(iCellScrollViewPageControlPosition)pageControlPosition{
