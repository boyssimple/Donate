...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    ...
    NSDictionary *attrDict = [NSDictionary dictionaryWithObjectsAndKeys:detailsLabel.font,NSFontAttributeName,paragraphStyle,NSParagraphStyleAttributeName, nil];
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin attributes:attrDict context:nil].size;
